...
class RequestHistoriesControllerTest < ActionController::TestCase
  ...
  test "should create request_history" do
    assert_difference('RequestHistory.count') do
      post :create, request_history: { comments: @request_history.comments, request_id: @request_history.request_id, status: @request_history.status }
    end
  ...
  test "should update request_history" do
    patch :update, id: @request_history, request_history: { comments: @request_history.comments, request_id: @request_history.request_id, status: @request_history.status }
    assert_redirected_to request_history_path(assigns(:request_history))
  end
